...
The **AI Models** layer (under Platforms & Software) stands in for the model makers. OpenAI and Anthropic are private, so *Frontier Lab Backers* holds their largest listed stakeholders - SoftBank and Microsoft (OpenAI), Alphabet and Amazon (Anthropic, and Gemini at Alphabet) - which move far more on their other businesses than on the labs; *Listed Model Labs* holds the model developers that do trade: Zhipu and MiniMax (Hong Kong IPOs, January 2026), SenseTime and iFlytek.
